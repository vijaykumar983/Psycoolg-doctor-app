package com.psycoolgdoctor.ui.components.activities.intro;
...
import com.psycoolgdoctor.databinding.ActivityIntroBinding;
import com.psycoolgdoctor.ui.base.BaseBindingActivity;
import com.psycoolgdoctor.ui.components.activities.termCondition.TermConditioinActivity;
import com.psycoolgdoctor.ui.components.adapters.CustomPagerAdapter;
        ...
        switch (view.getId()) {
            case R.id.btnNext:
                if (binding.viewPager.getCurrentItem() == 2) {
                    TermConditioinActivity.startActivity(mActivity,null,false);
                } else {

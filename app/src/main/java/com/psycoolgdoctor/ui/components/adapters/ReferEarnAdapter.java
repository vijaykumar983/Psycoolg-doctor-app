...
public class ReferEarnAdapter extends RecyclerBaseAdapter {
    private Context context;
    private View.OnClickListener onClickListener;

    public ReferEarnAdapter(Context context, View.OnClickListener onClickListener) {
    ...
    protected int getLayoutIdForPosition(int position) {
        return R.layout.row_refer_earn;
    }
    ...
    protected void putViewDataBinding(ViewDataBinding viewDataBinding, int position) {
        ...
        RelativeLayout rootHeader = view.findViewById(R.id.rowReferItem);

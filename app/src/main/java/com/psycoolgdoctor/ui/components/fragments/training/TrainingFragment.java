...
public class TrainingFragment extends BaseFragment {
    ...
    public void onResume() {
        ...
        binding.appBar.tvTitle.setText("Training Video");
    ...
    private void setAdapter() {
        binding.rvTraining.setAdapter(new TrainingAdapter(mActivity, onClickListener));
    }

...
public class OfferFragment extends BaseFragment {
    ...
    private void setAdapter() {
        binding.rvOffers.setAdapter(new OfferAdapter(mActivity, onClickListener));
    }

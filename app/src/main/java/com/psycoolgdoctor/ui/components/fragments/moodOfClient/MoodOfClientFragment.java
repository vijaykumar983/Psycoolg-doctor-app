...
import com.psycoolgdoctor.databinding.FragmentMoodOfClientBinding;
import com.psycoolgdoctor.ui.base.BaseFragment;
import com.psycoolgdoctor.ui.components.activities.home.HomeActivity;

public class MoodOfClientFragment extends BaseFragment {
    private FragmentMoodOfClientBinding binding;
    private MoodOfClientViewModel homeViewModel;
    private View.OnClickListener onClickListener = null;
    private HomeActivity homeActivity;

    @Override
    protected ViewDataBinding setBinding(LayoutInflater inflater, ViewGroup container) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_mood_of_client, container, false);
    ...
    public void onResume() {
        ...
        binding.appBar.tvTitle.setText("Mood Of Client");

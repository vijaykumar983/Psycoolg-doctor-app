package com.psycoolgdoctor.ui.components.activities.writeBlog;
...
public class WriteBlogActivity extends BaseBindingActivity {
    private ActivityWriteBlogBinding binding;

    @Override
    protected void setBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_write_blog);
    }
    ...
    binding.appBar.tvTitle.setText("Write Blog");
    }
    ...
    public static void startActivity(Activity activity, Bundle bundle, boolean isClear) {
        Intent intent = new Intent(activity, WriteBlogActivity.class);
